	...
	namespace Math{
		...
		public:
			...
			public:
				...
				Vector3 getPixelVec(int x,int y);
				Vector4 getPixelVecWithAlpha(int x,int y);
				Vector2 getSize();
				
				void setPixelVec4(int x,int y,Vector4 color);
				void setPixelVec3(int x,int y,Vector3 color);
