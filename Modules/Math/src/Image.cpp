...
namespace DogGE
{
	namespace Math{
		...
		*/
		Vector3 Image::getPixelVec(int x,int y)
		{
			Vector3 ret;
		...
		//------------------------------------
		Vector4 Image::getPixelVecWithAlpha(int x,int y)
		{
			Vector4 ret;
			/*
			if(hasAlpha())
		...
		*/
		void Image::setPixelVec4(int x,int y,Vector4 color)
		{
		...
		//------------------------------------
		void Image::setPixelVec3(int x,int y,Vector3 color)
		{
			if(x < 0 || x > m_width || y < 0 ||y > m_height)
			{
				return;
